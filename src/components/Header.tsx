    ...
    <header className="bg-white border-b-4 border-sweepstakes-gold shadow-lg">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center space-x-6">
          <div className="flex-shrink-0 p-2 bg-gradient-to-br from-sweepstakes-gold to-sweepstakes-gold-dark rounded-full shadow-md">
            <img 
          ...
          <div className="text-center border-l-2 border-sweepstakes-gold pl-6">
            <h1 className="text-sweepstakes-navy text-2xl md:text-3xl font-bold leading-tight mb-1 relative">
            ...
            <p className="text-sweepstakes-gold text-base md:text-lg font-semibold mt-2 px-4 py-1 bg-sweepstakes-navy/5 rounded-full border border-sweepstakes-gold/20">
